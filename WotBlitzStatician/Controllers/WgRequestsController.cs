...
namespace WotBlitzStatician.Controllers
{
  ...
  public class WgRequestsController : Controller
  {
    ...
    // api/WgRequests/FindAccounts/Swarov5
    [HttpGet("FindAccounts/{accountNameTemplate}")]
    public async Task<IActionResult> FindAccounts(string accountNameTemplate)
    {
      var result = await _wargamingApiClient.FindAccountAsync(accountNameTemplate);
      return Ok(result);
    }
  }
}
