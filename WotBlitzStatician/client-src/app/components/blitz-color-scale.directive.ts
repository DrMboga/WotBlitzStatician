...
export class BlitzColorScaleDirective {
  ...
  private _scaleClassColors: SclaeColor[];
  ...
  constructor(private renderer: Renderer2, private element: ElementRef) {
    this._scaleClassColors = new Array(
      ...
      { scaleMinValue: 0.47, scaleMaxValue: 0.4899, scaleClass: "scale-below-average" },
      { scaleMinValue: 0.49, scaleMaxValue: 0.5199, scaleClass: "scale-average" },
      ...
      { scaleMinValue: 1350, scaleMaxValue: 1549, scaleClass: "scale-very-good" },
      ...
      { scaleMinValue: 2050, scaleMaxValue: 10000, scaleClass: "scale-super-unicum" },
    );
  }
  ...
  set scaleValue(value: number) {
    ...
    for (let scaleClassColor of this._scaleClassColors) {
      if (value >= scaleClassColor.scaleMinValue && value <= scaleClassColor.scaleMaxValue) {
        this.renderer.addClass(this.element.nativeElement, scaleClassColor.scaleClass);
        return;
      }
    }
  }
